...
from src.perception.lane_detector import LaneInfo
...
class DrivingAction:
    ...
    def __repr__(self):
        return (
            f"DrivingAction({self.behavior}, accel={self.accelerate:.2f}, "
...
class WorldContext:
    ...
    lane_info: LaneInfo | None = None
    collision_info: CollisionInfo | None = None
    collision_active: bool = False
    collision_recovered: bool = False

    speed_info: SpeedInfo | None = None
    ...
    def update(
        ...
        self.collision_active = collision_info is not None and collision_info.collision_detected
        ...
        self.stop_sign_ahead = any(d.class_name == "stop_sign" for d in frontal)
